...
def lstm_text(EMBEDDING_DIM, MAX_SEQUENCE_LENGTH, MAX_NB_WORDS, embeddings_index, word_index, labels_index):
    """
    Bidirectional LSTM neural network model for text classification.
